...
if (settingsContainer && dashboardContainer) {
  ReactDOM.render(<Settings nonce={nonce} urls={urls} croppedSizes={croppedSizes} />, settingsContainer);
  ReactDOM.render(<Dashboard urls={urls} nonce={nonce} imageSizes={imageSizes} croppedSizes={croppedSizes} />, dashboardContainer);
}