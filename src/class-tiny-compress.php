...
abstract class Tiny_Compress {
	...
	public function compress_file( $file, $resize_opts = array(), $preserve_opts = array(), $original_file, $size ) {
		if ( $this->get_key() == null ) {
	...
	protected abstract function compress( $input, $resize_options, $preserve_options, $original_file, $size );
